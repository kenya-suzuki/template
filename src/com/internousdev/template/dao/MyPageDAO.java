...
public class MyPageDAO {
	 ...
	 * @throws SQLException
	 */
	public ArrayList<MyPageDTO> getMyPageUserInfo(int userId) throws SQLException {
		...
		try {
			...
			while(resultSet.next()) {
				...
				dto.setItemName(resultSet.getString("item_transaction_name"));
	 ...
	 * @throws SQLException
	 */
	public int buyItemHistoryDelete(String deleteFlg) throws SQLException {
